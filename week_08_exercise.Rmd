...
gap_bubble_interactive
library(htmlwidgets)
saveWidget(gap_bubble_interactive, file = here("images", "gap_bubble_interactive.html"))
...
```{r}
# install.packages("gganimate") # à exécuter si pas encore installé
library(gganimate)
...
# anim_save("images/gap_bubble_anim.gif")
